...
g=-9.81 ; miu=0.001 ; ro=1000 ; u0=-.001 ; pinfinity=101300 ; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%
P=( 0.25/6 )*-u0 ;%%%neuman boundary conditions L/2=.25/6 and integral (1/2(1-x)dx)|(1,-1)=1
for i=1:1:nnod     
    
    %%%inlet
     
   if(i==7||i==6)
globalmatrix_r(i,1)=globalmatrix_r(i,1)+P ; 
   end
  if(i==9||i==8)
globalmatrix_r(i,1)=globalmatrix_r(i,1)+2*P ;   
  end
